...
`)),o+=p+s[c+1]}),o}const Sl=e=>"<td>"+e.join("</td><td>")+"</td>",Vr=e=>'<table class="table"><tr>'+e.map(Sl).join("</tr><tr>")+"</tr></table>",$n=e=>Vr(e.map(t=>[t])),me=e=>e.join('<div class="divider"></div>'),j=(e,t="")=>y`
    ...
    `,P=(e,t,n=[])=>({title:e,description:t,children:n}),Al=P("Introduction",[y`
    ...
    ${Vr([["","Name","The weapon's name"],["ATK","Attacks","The number of attack dice to roll whenever an operative uses this weapon."],["DMG","Damage","The damage each dice inflicts. The first number is its Normal Dmg stat, the second value is its Critical Dmg stat."],["WR","Weapon Rules",y`
    ...
    `,[Il,Rl,Dl,Fl]),jl=P("Overencumberance",y`
    `),Hl=P("Carrying Large Objects",y`
    `),Nl=P("Carrying Incapacitated Operatives",y`
    `),Ll=P("Carrying Capacity",y`
    `,[jl,Hl,Nl]),kl=P("Burning",y`
    `),Wl=P("Poisoned",y`
    `),Vl=P("Bleeding",y`
    `),Ul=P("Blinded",y`
    `),ql=P("Immobilized",y`
    `),Bl=P("Jammed Weapons",y`
    `),Kl=P("Weakened",y`
    `),Gl=P("Conditions",y`
    `,[kl,Wl,Vl,Ul,ql,Bl,Kl]),Jl=P("Operatives",y`
    ...
    `,[Pl,Ol,Ml,$l,Ll,Gl]),zl=P("Determine Order",y`
    `,[]),Yl=be("Move",1,me([j("Move the active operative up to its MV stat to a position in which it can be placed.","alert-success alert-soft"),j(y`
        ...
        `])),Zl=be("Fall Back",2,me([j(y`
            ...
            `,"alert-error alert-soft")])),Ql=be("Charge",1,me([j(y`
            ...
            `,"alert-error alert-soft")])),ea=be("Interact",1,me([j(y`
            ...
            `,"alert-error alert-soft")])),ta=be("Pick Up",1,me([j(y`
            ...
            `,"alert-error alert-soft")])),na=be("Drop",1,me([j(y`
            ...
            `,"alert-error alert-soft")])),sa=be("Equip",2,me([j(y`
            ...
            `,"alert-error alert-soft")])),ra=be("Unequip",2,me([j(y`
            The operative unequips an item it is equipped with. Move that item to the operative’s inventory.
            `,"alert-success alert-soft"),j(y`
            An operative cannot perform this action while within control range of an
            enemy operative or while it is overencumbered.
            `,"alert-error alert-soft")])),ia=be("Use Consumable",1,me([j(y`
            ...
            `,"alert-error alert-soft")])),oa=be("Shoot",1,me([j(y`
    ...
    `,[]),ca=P("Performing Actions",y`
    `,[]),fa=P("A Player's turn",y`
    `,[zl,ca,aa]),ua=P("Light Terrain",y`
    `,[]),ha=P("Heavy Terrain",y`
    `,[]),da=P("Intervening Terrain",y`
    `,[]),pa=P("Vantage Terrain",y`
    `,[]),ga=P("Molten Ground",y`
    `,[]),ma=P("Radiant Zone",y`
    `,[]),ba=P("Sanctified Ground",y`
    `,[]),va=P("Terrain",y`
    `,[ua,ha,da,pa,ga,ma,ba]),ya=P("Bases",y`
    `,[]),wa=P("Control Range",y`
    `,[]),_a=P("Cover",y`
    `,[]),xa=P("Dice",y`
    `,[]),Ta=P("Distances",y`
    `,[]),Ca=P("Obscured",y`
    `,[]),Sa=P("Visible",y`
    `,[]),Aa=P("Other Key Principles",y`
    `,[ya,wa,_a,xa,Ta,Ca,Sa]),Ea=P("Weapon Keywords",y`
    `,[]),Ur=[Al,El,Jl,fa,va,Aa,Ea],qr=(e,t)=>{const n=[{path:e,title:t.title,description:t.description}];return t.children?n.concat(t.children.flatMap((s,r)=>qr(e.concat([r]),s))):n},Pa=Ur.flatMap((e,t)=>qr([t],e)),Br=(e,t)=>n=>{if(e.length===0)return t;{const r=e[0],i=e.slice(1);return Br(i,n(t,r))(n)}},Oa=(e,t)=>{const n=[];for(let s=0;s<e.length;s++)s!==0&&n.push(t),n.push(e[s]);return n};class Ma{html;constructor(t){this.html=t}linkify(t){return[this]}}class ns{html;constructor(t){this.html=t}linkify(t){return Oa(this.html.split(new RegExp(RegExp.escape(t.title),"ig")).map(n=>new ns(n)),new Ma(Ia(t.path.join("_"),t.title)))}}const Ia=(e,t)=>y`
    <a class="link link-primary" onclick="modal_${e}.showModal()">${t}</a>
    `,Ra=(e,t)=>Br(Pa.filter(n=>n.title.toLowerCase()!=t.toLowerCase()),[new ns(e)])((n,s)=>n.flatMap(r=>r.linkify(s))).map(n=>n.html).join(""),Da=["id"],Fa=["innerHTML"],$a=["id"],ja={class:"modal-box max-w-5xl"},Ha={class:"text-lg font-bold"},Na=["href","onclick"],La=["innerHTML"],ka=on({__name:"Rule",props:{path:{},item:{}},setup(e){return(t,n)=>{const s=vr("Rule",!0);return oe(),Fe(ue,null,[J("h2",{id:"rule-"+e.path.join("-"),class:"px-5 pb-5 text-2xl"},St(e.item.title),9,Da),J("div",{innerHTML:zn(Ra)(e.item.description,e.item.title),class:"px-5 pb-5"},null,8,Fa),J("dialog",{id:`modal_${e.path.join("_")}`,class:"modal modal-bottom sm:modal-middle"},[J("div",ja,[n[0]||(n[0]=J("form",{method:"dialog"},[J("button",{class:"btn btn-sm btn-circle btn-ghost absolute right-2 top-2 outline-none"},"✕")],-1)),J("h3",Ha,[J("a",{href:`#rule-${e.path.join("-")}`,onclick:`modal_${e.path.join("_")}.close()`},St(e.item.title),9,Na)]),J("div",{class:"p-2 text-justify",innerHTML:e.item.description},null,8,La)]),n[1]||(n[1]=J("label",{class:"modal-backdrop",for:"${modalId}"},"Close",-1))],8,$a),e.item.children?(oe(!0),Fe(ue,{key:0},zt(e.item.children,(r,i)=>(oe(),ct(s,{path:e.path.concat(i),item:r},null,8,["path","item"]))),256)):jo("",!0)],64)}}}),Wa={class:"drawer lg:drawer-open"},Va={class:"drawer-content flex flex-col items-center justify-center"},Ua={class:"flex flex-col"},qa={class:"drawer-side z-1"},Ba={class:"menu bg-base-200 min-h-full w-80 p-4"},Ka=on({__name:"Index",props:{rules:{}},setup(e){return(t,n)=>(oe(),Fe("div",Wa,[n[3]||(n[3]=J("input",{type:"checkbox",class:"drawer-toggle"},null,-1)),J("div",Va,[n[0]||(n[0]=J("h1",{class:"text-5xl p-5"},"DOOMTROOPERS 2025",-1)),n[1]||(n[1]=J("h2",{class:"text-3xl p-5"},"Rules",-1)),J("div",Ua,[(oe(!0),Fe(ue,null,zt(e.rules,(s,r)=>(oe(),ct(ka,{path:[r],item:s},null,8,["path","item"]))),256))])]),J("div",qa,[n[2]||(n[2]=J("label",{for:"my-drawer-3","aria-label":"close sidebar",class:"drawer-overlay"},null,-1)),J("ul",Ba,[(oe(!0),Fe(ue,null,zt(e.rules,(s,r)=>(oe(),ct(Cl,{path:[r],item:s},null,8,["path","item"]))),256))])])]))}}),Ga=on({__name:"App",setup(e){return(t,n)=>(oe(),ct(Ka,{rules:zn(Ur)},null,8,["rules"]))}});vl(Ga).mount("#app");
